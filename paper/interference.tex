...
\begin{figure}[t!]
  \centering
  \subfloat[BB0 < \textcolor{myred}{BB1} < \textcolor{myblue}{BB2} < BB3]{\includegraphics[width=0.35\textwidth]{lin1}} \hfill
  \subfloat[BB0 < \textcolor{myblue}{BB2} < \textcolor{myred}{BB1} < BB3]{\includegraphics[width=0.35\textwidth]{lin2}}
